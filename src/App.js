...
function Vignette (props) {
  return (
    <div>
      ...
      <h3>{props.title}</h3>
      <h4><a href={props.linkHref}>{props.callToAction}</a></h4>
    </div>
  )
}
...
function Logo (props) {
  return (
  <img src="logo.svg" className="logo" alt="Artsonia" />)
}
...
function SearchGlobal (props) {
  return (
    <div className="globalSearch">
      <input type="search" placeholder="Search schools or students" /><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"><path fill="#84858B" fill-rule="evenodd" d="M11.3 6.1A5.1 5.1 0 1 1 1 6.1a5.1 5.1 0 0 1 10.3 0zm-1.6 5a6.1 6.1 0 1 1 1.4-1.4l.3.2 4.3 4.4a1 1 0 1 1-1.4 1.4l-4.4-4.3-.2-.3z" clip-rule="evenodd"/></svg>
    </div>
  );
}
...
function Hero (props) {
  return (
    <div className="hero">
      ...
      <h1>All with <span>Artsonia.</span></h1>
    </div>
  )
}
function BigCtaBlock (props) {
  return (
    <div>
      ...
      <h3>
        <a href={props.cta1Href}><button>{props.cta1}</button></a> or
        <a href={props.cta2Href}><button>{props.cta2}</button></a>
      </h3>
    </div>
  );
}
  ...
  render () {
    return (
      <div>
        ...
        <Hero />
        <Vignette imgSrc="abc" imgAltText="Illustration" title="Upload and edit student art to perfection" linkHref="#" callToAction="See How It Works" />
        <Vignette imgSrc="abc" imgAltText="Illustration" title="Publish digital portfolios from school or home" linkHref="#" callToAction="Explore Portfolios" />
        <Vignette imgSrc="abc" imgAltText="Illustration" title="Purchase and personalize custom keepsakes" linkHref="#" callToAction="Go Shopping" />
        <Vignette imgSrc="abc" imgAltText="Illustration" title="For every keepsake sold, we donate 20% to the school arts program" linkHref="#" callToAction="Learn About Us" />
        <BigCtaBlock title="Artsonia is even better when it's for you" description="Artsonia is the world's largest collection of student art, published by teachers and students from around the world." cta1="Take a Tour" cta1Href="https://www.google.com" cta2="Sign Up" />
        <ArtistOfTheWeek />
        <Footer />
      </div>
    )
